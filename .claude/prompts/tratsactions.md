...
Обнови модель User и Category - добавь обратные связи в transactions Transaction[]

После изменения схемы создай и примени миграцию
npm prisma migrate dev --name add-transactions
...
- GET /transactions: список с query параметрами dateFrom6 dateTo6 type, categoryId (по пользователю)
- GET /transactions/summary: агругация, query параметры month и year (оба обязательные)
